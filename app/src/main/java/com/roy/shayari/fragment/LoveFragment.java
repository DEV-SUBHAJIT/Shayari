...
public class LoveFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        ...
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_love);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("Shayari");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, LoveFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/2057294928");

        mAdView = view.findViewById(R.id.adView_love);
