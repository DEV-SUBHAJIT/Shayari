...
public class HindiFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.hindi_recyclerview);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_hindi);
    ...
    private void loadData() {
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, HindiFragment.this);
