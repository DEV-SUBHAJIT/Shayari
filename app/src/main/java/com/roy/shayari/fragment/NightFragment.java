...
public class NightFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.night_recyclerview);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_night);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("Night");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, NightFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/6502972244");

        mAdView = view.findViewById(R.id.adView_night);
