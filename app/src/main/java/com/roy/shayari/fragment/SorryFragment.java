...
public class SorryFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.sorry_recyclerview);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_sorry);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("Sorry");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, SorryFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/9131783827");

        mAdView = view.findViewById(R.id.adView_sorry);
