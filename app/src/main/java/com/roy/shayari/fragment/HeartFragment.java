...
public class HeartFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        ...
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_heart);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("HeartTouching");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, HeartFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/9205496517");

        mAdView = view.findViewById(R.id.adView_heart);
