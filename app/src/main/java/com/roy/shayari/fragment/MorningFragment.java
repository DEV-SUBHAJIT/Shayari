...
public class MorningFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.morning_recyclerview);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_morning);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("Morning");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, MorningFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/1482579858");

        mAdView = view.findViewById(R.id.adView_morning);
