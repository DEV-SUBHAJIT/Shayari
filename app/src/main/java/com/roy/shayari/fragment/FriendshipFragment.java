...
public class FriendshipFragment extends Fragment implements TextAdapter.ItemClick {
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.friendship_recyclerview);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_layout_friendship);
    ...
    private void loadData() {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("Friendship");
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                textAdapter = new TextAdapter((ArrayList<Text>) textList, FriendshipFragment.this);
    ...
    private void loadAd(View view) {
        ...
        adView.setAdUnitId("ca-app-pub-4909264441583347/4039626289");

        mAdView = view.findViewById(R.id.adView_friendship);
